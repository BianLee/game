...
class LouisianaStateUniversity extends React.Component {
  render() {
    return (
      <>
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 524 163" style={{pointerEvents: "none"}}  >
...
export default LouisianaStateUniversity;
